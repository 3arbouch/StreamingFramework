...
/**
 * Instruction to order the client stop recording and streaming live audio.
 * @author MohamedBenArbia
 *
 */
public class StopRecordAudioInstruction implements Instruction {

	
	private InstructionMessages mInstructionMessage = InstructionMessages.STOPRECORDAUDIO;
	...
	public static Instruction getInstructionFromString(String receivedMessage) {
		return new StopRecordAudioInstruction() ; 
	}
