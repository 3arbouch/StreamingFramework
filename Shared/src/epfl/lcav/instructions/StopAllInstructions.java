...
/**
 * Instruction to order the client stop all the running services.
 * @author MohamedBenArbia
 *
 */
public class StopAllInstructions implements Instruction {
	private InstructionMessages mInstructionMessage = InstructionMessages.STOPALL;
	...
	public static Instruction getInstructionFromString(String receivedMessage) {
		return new StopAllInstructions() ; 
	}
}
